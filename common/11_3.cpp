...
bool Employee::operator>(Employee one)
{
    // 年龄最大的 
    // Date 类的 > 为 晚日期
    if (this->birthDate > one.birthDate)
    {
        return false;
    }
    else
...
int main()
{
    Date birth1(2000, 1, 5);
    Date hire1(2000, 1, 5);

    Date birth2(2000, 1, 4);
    Date hire2(2000, 1, 4);

    Date birth3(2000, 1, 1);
    Date hire3(2000, 1, 1);

    Date birth4(2000, 1, 4);
    Date hire4(2000, 1, 4);

    Date birth5(2000, 1, 5);
    Date hire5(2000, 1, 5);
